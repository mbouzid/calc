...
static const char qt_meta_stringdata_engine[] = {
    "engine\0\0result\0value(int)\0val\0"
    "set_first_operand(int)\0set_second_operand(int)\0"
    "index\0set_operator(int)\0calculate()\0"
};
...
void engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->set_first_operand((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->set_second_operand((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->set_operator((*reinterpret_cast< int(*)>(_a[1]))); break;
